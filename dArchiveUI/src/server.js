var sender = 'smtps://jieprojecttest%40gmail.com'   // The emailto use in sending the email
//(Change the @ symbol to %40 or do a url encoding )
var password = 'bcmuseum19'  // password of the email to use
...
exports.sendPasswordReset = function (email, username, name) {
    ...
    sendResetPasswordLink({
        to: email,
        subject: 'Password Reset - jieprojecttest.com'
    }, {
        name: name,
        username: username,
        token: tokenUrl
